  ...
  return (
    <div className="sr-page">
      ...
      <div className="sr-topbar">
        ...
        <Link to="/builder" className="sr-btn-new">+ Build New Resume</Link>
      </div>
      ...
      {!loading && !error && resumes.length === 0 && (
        <div className="sr-empty">
          ...
          <Link to="/builder" className="sr-btn-start">Start Building</Link>
        </div>
      )}
                ...
                <div className="sr-card-body">
                  <div className="sr-card-top">
                    <div>
                      ...
                      {r.targetJobTitle && (
                        <p className="sr-card-role">{r.targetJobTitle}</p>
                      )}
                    </div>
                  ...
                  <div className="sr-card-actions">
                    ...
                    <Link
                      to={`/builder?savedId=${r.id}&templateId=${r.templateId || ''}`}
