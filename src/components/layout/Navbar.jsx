        ...
        <div className={`navbar-links ${isMobileMenuOpen ? 'open' : ''}`}>
          {user && (
            <>
              ...
              <Link onClick={closeMenu} to="/builder"   className={`nav-link ${isActive('/builder')   ? 'active' : ''}`}>Builder</Link>
              ...
              {isAdmin && (
                <Link onClick={closeMenu} to="/admin" className={`nav-link nav-link-admin ${isActive('/admin') ? 'active' : ''}`}>
                  🛡️ Admin
                </Link>
              )}
            </>
          ...
          <div className="mobile-actions-container">
            ...
            {user ? (
             ...
             {user && (
                 <span className="nav-username" style={{marginTop: '12px', justifyContent: 'center'}}>
