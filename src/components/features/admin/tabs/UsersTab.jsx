    ...
    {loading?<div className="adm-loading"><div className="adm-spinner"></div><span>Loading…</span></div>:(
      <div className="adm-table-wrap"><table className="adm-table">
        ...
        <tbody>{filtered.map(u=>{
          const isAdm=u.roles?.includes('ADMIN'); const isBanned=!u.active; const isSelf=u.username===currentUsername;
          return(<tr key={u.id} className={isBanned?'adm-row--inactive':''}>
            ...
            <td><div className="adm-actions-cell" style={{flexWrap:'wrap',gap:4}}>
